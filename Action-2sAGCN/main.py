...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='./config/fatigue_skeleton/sanbao_test.yaml',
...
class Processor():
    ...
    def __init__(self, arg):
        ...
        dst_dir = self.arg.model_saved_name.replace(os.path.basename(self.arg.model_saved_name),'')
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            p,r = self.data_loader[ln].dataset.PR(score, 1)
            p,r = p*100,r*100
            self.print_log('\tPricision: {:.2f} %; Recall:{:.2f} %'.format(p,r))
