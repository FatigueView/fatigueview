...
def get_batch_data(video_list,suffix,batch_size,start_id,dst_dir,gpu_id=0,random_ratio = 0.05):
    ...
    while True:
        ...
        while True:
            ...
            left_frame_1 = eye_crop(frames[0],left_eye_1,ratio=1.2)
            right_frame_1 = eye_crop(frames[0], right_eye_1, ratio=1.2)
            ...
            img = np.concatenate([temp_frames[0],flow,raft_flow],axis = 0)
