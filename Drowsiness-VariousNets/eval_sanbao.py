...
if __name__ == '__main__':
    ...
    src_dir_dict = {'train':'./data/train',
                    'sanbao_test':'/mnt/data-1/zhenyu.yang/FatigueViewBaseline/Park2016DDD/data/sanbao_test'
    }

    weights = '/mnt/hdfs-data-6/data/zhenyu.yang/FatigueBaseline/park_data/weights'
    weights = '/home/users/zhenyu.yang/data/FatigueBaseLine/Park2016DDD/weights'
